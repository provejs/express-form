...
exports.toObject = function () {
	return this.add(function (value) {
		// return undefined to not change value
		if (!isString(value)) return undefined;
		try {
			value = JSON.parse(value);
			return value;
		} catch (e) {
			// todo: not clear how to handle this
...
exports.toSplit = function (delim) {
	delim = delim || ',';
	return this.add(function (value) {
...
exports.toCss = function (options) {
	options = options || {
	...
	return this.add(function (value) {
		if (!value) return value;
		return Beautify.css(value, options);
	});
};
...
exports.custom = function (func, message) {
	...
	if (func.length === 4) {
		return this.add(function (value, source, locals, cb) {
			...
			func.apply(this, [value, source, locals, callback]);
		});
	} else {
		...
		return this.add(function (value, source, locals) {
			...
			try {
				...
				result = func.apply(this, [value, source, locals]);
			} catch (e) {
				return {
