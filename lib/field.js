	...
	this.run = function (locals, source, form, options, cb) {
		...
		if (autoTrim) {
			...
			stack.unshift(function (value) {
				var sanitized = externalFilter.sanitize(value);
				return FilterPrototype.trim.apply(sanitized);
			});
		}
...
Field.prototype.ifNull = function (replacement) {
	return this.add(function (value) {
		if (isUndefined(value) || null === value || '' === value) {
			return replacement;
		}
		return value;
	});
...
Field.prototype.isNumeric = function (message) {
	return this.add(function (value) {
		if (isNumber(value) || (isString(value) && value.match(/^[-+]?[0-9]*\.?[0-9]+$/))) {
		} else {
...
Field.prototype.isFloat = Field.prototype.isDecimal = function (message) {
	return this.add(function (value) {
		if ((isNumber(value) && value % 1 == 0) || (isString(value) && value.match(/^[-+]?[0-9]*\.[0-9]+$/))) {
		} else {
